...
function save2pdf(pdfFileName,handle,dpi,papersize,cmyk)
...
pos = get(handle,'pos');
set(handle,'pos',[[pos(1) pos(2)] papersize]);
...
if cmyk
    disp('Plotting in CMYK colors');
    print(handle,'-dpdf','-cmyk',pdfFileName,sprintf('-r%d',dpi));
else
